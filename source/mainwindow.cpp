    ...
    : QMainWindow(parent)
{
    ...
    connect(settings_pg, &Settings::notification, main_pg, &MainPageWindow::handle_notification_mode);
    ...
    connect(main_pg, &MainPageWindow::loadChatonResponse, chat_pg, &ChatWidget::handleLoadChatOnResponse);
    changeTheme("Light");
...
void MainWindow::changeTheme(QString mode) {
    QString themeFile = (mode == "Dark") ? ":/styles/styles/darkmode.qss" : ":/styles/styles/lightmode.qss";
